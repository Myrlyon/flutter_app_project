...
TextStyle appBarText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w500,
        fontSize: figmaFontsize(14)));

TextStyle moneyText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w600,
        fontSize: figmaFontsize(18)));

TextStyle moneyMiniText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w400,
        fontSize: figmaFontsize(12)));

TextStyle headerText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w600,
        fontSize: figmaFontsize(18)));
TextStyle subheaderText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w500,
        fontSize: figmaFontsize(16)));

TextStyle commonText = GoogleFonts.nunitoSans(
    textStyle: TextStyle(
        color: primaryTextColor,
        fontWeight: FontWeight.w400,
