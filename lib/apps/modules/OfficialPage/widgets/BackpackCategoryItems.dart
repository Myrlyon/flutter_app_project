...
class BackpackCategoryItems extends StatefulWidget {
  const BackpackCategoryItems({super.key});

  @override
  State<BackpackCategoryItems> createState() => _BackpackCategoryItemsState();
}

class _BackpackCategoryItemsState extends State<BackpackCategoryItems> {
  ...
  void initState() {
    ...
    itemModelList =
        itemModelList.where((item) => item.category == 'Backpack').toList();
  }
